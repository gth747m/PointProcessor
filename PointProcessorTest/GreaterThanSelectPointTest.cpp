...
TEST(GreaterThanSelectPoint, Int32)
{
    double values[5] = { 0.0 };
    ...
    auto point = GreaterThanSelectPoint<int32_t>(&values[4], &qualities[4], &durations[4]);
...
TEST(GreaterThanSelectPoint, Int64)
{
    double values[5] = { 0.0 };
    Quality qualities[5] = { Quality::UNKNOWN };
    std::chrono::duration<int, std::micro> durations[5];
    ...
    auto point = GreaterThanSelectPoint<int64_t>(&values[4], &qualities[4], &durations[4]);
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
    inpA.set_value(255);
    inpB.set_value(-200);
...
TEST(GreaterThanSelectPoint, Float)
{
    double values[5] = { 0.0 };
    Quality qualities[5] = { Quality::UNKNOWN };
    std::chrono::duration<int, std::micro> durations[5];
    ...
    auto point = GreaterThanSelectPoint<float>(&values[4], &qualities[4], &durations[4]);
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
...
TEST(GreaterThanSelectPoint, Double)
{
    double values[5] = { 0.0 };
    Quality qualities[5] = { Quality::UNKNOWN };
    std::chrono::duration<int, std::micro> durations[5];
    ...
    auto point = GreaterThanSelectPoint<double>(&values[4], &qualities[4], &durations[4]);
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
