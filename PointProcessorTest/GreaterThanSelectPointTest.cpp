...
TEST(GreaterThanSelectPoint, Int32)
{
    ...
    auto point = GreaterThanSelectPoint<int32_t>();
...
TEST(GreaterThanSelectPoint, Int64)
{
    ...
    auto point = GreaterThanSelectPoint<int64_t>();
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
    inpA.set_value(255);
    inpB.set_value(-200);
...
TEST(GreaterThanSelectPoint, Float)
{
    ...
    auto point = GreaterThanSelectPoint<float>();
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
...
TEST(GreaterThanSelectPoint, Double)
{
    ...
    auto point = GreaterThanSelectPoint<double>();
    point.set_inputs(&inpA, &inpB);
    point.set_outputs(&outA, &outB);
