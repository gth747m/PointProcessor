...
namespace ModbusLib
{
    ...
    public:
        ...
        static void build_read_request(int slaveAddress, int startAddress, int numRegisters, std::vector<unsigned char>* msg);
        ...
        static void build_write_request(int slaveAddress, int startAddress, std::vector<int>* values, std::vector<unsigned char>* msg);
        ...
        /// <param name="values">Array of values to set the registers to</param>
        /// <param name="msg">Modbus message buffer requesting a write of registers</param>
        static void build_write_request(int slaveAddress, int startAddress, std::vector<float>* values, std::vector<unsigned char>* msg);
    };
}
